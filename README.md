...
insert into users values('durga','durga','durga','jinna','telangana','1236547089','durga@gmail.com',2);
...
- Open Eclipse Enterprise Edition. [Install, if not already installed.]

- Click On File > Import > Git > Projects From Git > Clone Uri >

- Go inside ```src/main/resources > application.properties``` and update the value of database details as per your usage, like db.driver, db.host, db.username and db.password according to your installed mysql/postgresql admin user credentials.

- Right Click on Project > Run as > Maven Build > In the goals field enter "clean install" > apply > run

- Right Click On Project > Build Path > Configure Build Path > Libraries > Remove and Update Any Libraries if Red Mark Exists > Finish.
...
- The default Username And Password For User Is "durga" And "durga"
